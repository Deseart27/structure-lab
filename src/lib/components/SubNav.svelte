<script lang="ts">
	...
	let sections = $derived<SectionConfig[]>(
		version === 'v9' || version === 'v10' || version === 'v11' || version === 'v12'
			? v9Sections
	...
	function isActive(item: SubItem): boolean {
		...
		if ((version === 'v9' || version === 'v10' || version === 'v11' || version === 'v12') && item.match === '/prospects' && (item.label === 'Lists' || item.label === 'Contacts')) {
