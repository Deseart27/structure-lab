<script lang="ts">
	...
	const lists: ProspectList[] = [
		...
		{ id: '6', name: 'Newsletter Reverse Lookup', count: 67, enriched: 52, crmSynced: true, owner: 'Francis', updated: '2 weeks ago' },
		{ id: '7', name: 'Clay Workflow Import', count: 320, enriched: 298, crmSynced: true, owner: 'Marie', updated: '2 weeks ago' },
		{ id: '8', name: 'Claude MCP Batch', count: 50, enriched: 50, crmSynced: false, owner: 'Francis', updated: '3 weeks ago' },
	];
