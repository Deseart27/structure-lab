...
<section class="page m-2 flex rounded-3xl">
	<main
		...
		class:h-[calc(100vh-72px-16px)]={version !== 'v2' && version !== 'v3' && version !== 'v6' && version !== 'v7' && version !== 'v8' && version !== 'v9' && version !== 'v10'}
		class:h-[calc(100vh-72px-40px-16px)]={version === 'v2' || version === 'v3' || version === 'v6' || version === 'v7' || version === 'v8' || version === 'v9' || version === 'v10'}
	>
		<!-- Sidebar -->
		<aside
			class="border-grey-200 flex min-h-0 flex-col overflow-hidden rounded-l-2xl border bg-white text-sm"
		>
			{#if version !== 'v2' && version !== 'v3' && version !== 'v6' && version !== 'v7' && version !== 'v8' && version !== 'v9' && version !== 'v10'}
			...
			{#if currentTab !== 'lists' || version === 'v2' || version === 'v3' || version === 'v4' || version === 'v6' || version === 'v7' || version === 'v8' || version === 'v9' || version === 'v10'}
				<!-- Filters sidebar -->
